#!/usr/bin/env python3
"""
CI/CD Execution Harness for web-application-recon-and-enumeration
...
SKILL_NAME = "web-application-recon-and-enumeration"
SKILL_CATEGORY = "bug-hunting/recon-&-enumeration"
