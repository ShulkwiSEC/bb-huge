#!/usr/bin/env python3
"""
CI/CD Execution Harness for java-insecure-deserialization-ysoserial
...
SKILL_NAME = "java-insecure-deserialization-ysoserial"
SKILL_CATEGORY = "bug-hunting/deserialization"
