#!/usr/bin/env python3
"""
CI/CD Execution Harness for burp-suite-advanced-methodology
...
SKILL_NAME = "burp-suite-advanced-methodology"
SKILL_CATEGORY = "penetration-testing/web-application"
