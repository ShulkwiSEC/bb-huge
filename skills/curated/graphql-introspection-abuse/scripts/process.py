#!/usr/bin/env python3
"""
CI/CD Execution Harness for graphql-introspection-abuse
...
SKILL_NAME = "graphql-introspection-abuse"
SKILL_CATEGORY = "bug-hunting/apis"
MITRE_TECHNIQUES = ['T1592.004']
