#!/usr/bin/env python3
"""
CI/CD Execution Harness for insecure-direct-object-reference-idor
...
SKILL_NAME = "insecure-direct-object-reference-idor"
SKILL_CATEGORY = "bug-hunting/business-logic"
MITRE_TECHNIQUES = ['T1212']
