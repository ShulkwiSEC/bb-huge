#!/usr/bin/env python3
"""
CI/CD Execution Harness for active-directory-full-attack-chain
...
SKILL_NAME = "active-directory-full-attack-chain"
SKILL_CATEGORY = "penetration-testing/network"
MITRE_TECHNIQUES = ['T1558', 'T1003', 'T1021', 'T1087']
